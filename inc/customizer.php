 ...
 */
function innovi_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
}
add_action( 'customize_register', 'innovi_customize_register' );

/**
 * Binds JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function innovi_customize_preview_js() {
	wp_enqueue_script( 'innovi_customizer_preview', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '1.0', true );
}
// add_action( 'customize_preview_init', 'innovi_customize_preview_js' );

/**
 * [innovi_theme_option description]
 * @param  [type] $wp_customize [description]
 */
function innovi_theme_option( $wp_customize ) {
    // panel
...
add_action( 'customize_register', 'innovi_theme_option' );

/**
 * [innovi_social_array description]
 * @return [type] [description]
 */
function innovi_social_array() {
    ...
    return apply_filters( 'innovi_social_array_filter', $social_sites );
}
/**
 * [innovi_social_link_section description]
 * @param  [type] $wp_customize [description]
 * @return [type]               [description]
 */
function innovi_social_link_section( $wp_customize ) {

    $social_sites = innovi_social_array();

    // set a priority used to order the social sites
    $priority = 5;

    // section
    $wp_customize->add_section( 'innovi_social_icon', array(
...
add_action( 'customize_register', 'innovi_social_link_section' );

/**
 * [innovi_show_social_icons description]
 * @return [type] [description]
 */
function innovi_show_social_icons() {
...
/**
 * [innovi_marquee_newsfeed description]
 * @param  [type] $wp_customize [description]
 * @return [type]               [description]
 */
function innovi_marquee_newsfeed( $wp_customize ) {
    // section
...
add_action( 'customize_register', 'innovi_marquee_newsfeed' );
 ...
 * @param  [type] $wp_customize [description]
 */
function innovi_homepage_news_slider( $wp_customize ) {
    // section
...
add_action( 'customize_register', 'innovi_homepage_news_slider' );

/**
 * [innovi_show_carousel description]
 * @param  [type]  $tag_name   [description]
 * @param  integer $post_count [description]
 */
function innovi_show_carousel() {
...
/**
 * [innovi_homepage_news_category description]
 * @param  [type] $wp_customize [description]
 * @return [type]               [description]
 */
function innovi_homepage_news_category( $wp_customize ) {
    // section
...
add_action( 'customize_register', 'innovi_homepage_news_category' );
